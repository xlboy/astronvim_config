return {
  require("user.plugins.astro.community"),
  require("user.plugins.astro.default"),

  require("user.plugins.language.cmp"),
  require("user.plugins.language.mason"),
  require("user.plugins.language.null-ls"),
  require("user.plugins.language.treesitter"),
  require("user.plugins.language.lsp-helpers"),

  require("user.plugins.infrastructure.telescope"),
